  ...
  imports: [
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => ({
        ...
        entities: [User, Role, Permission, Ticket, Message, Setting, KnowledgeDoc, AuditLog, TicketCategory, Post, PostComment, BbsSection, BbsTag, TicketReadState, BbsSubscription],
